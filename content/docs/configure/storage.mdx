...
local storage automatically under `.objectstack/data/uploads/`. Override
the root directory with the `OS_STORAGE_ROOT` environment variable.
...
- [System settings](/docs/configure/system-settings) — live
