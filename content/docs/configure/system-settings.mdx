...
ObjectOS exposes those settings through the Setup app when the application
...
| Setup UI | Renders standard settings pages |
...
environment variable, the Setup UI should show it as managed by the host
