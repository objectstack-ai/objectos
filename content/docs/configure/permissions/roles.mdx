...
Use [permission sets](/docs/configure/permissions/permission-sets) to grant
concrete object, field, and system capabilities.
...
- granting broad access through manager roles when
  [record sharing](/docs/configure/permissions/record-access) would be more
  precise.
