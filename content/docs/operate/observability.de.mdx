...
Für OpenTelemetry setzen Sie `OTEL_EXPORTER_OTLP_ENDPOINT`, und ObjectOS gibt
Traces und Metriken im OTLP-Format aus. Die Struktur der Spans entspricht dem
