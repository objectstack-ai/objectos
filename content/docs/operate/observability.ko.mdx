...
OpenTelemetry의 경우 `OTEL_EXPORTER_OTLP_ENDPOINT`를 설정하면 ObjectOS가 OTLP
형식으로 트레이스와 메트릭을 내보냅니다. 스팬의 형태는
[요청 흐름](/docs/architecture#how-a-request-is-served)과 일치합니다.
