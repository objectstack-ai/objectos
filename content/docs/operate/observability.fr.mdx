...
Pour OpenTelemetry, définissez `OTEL_EXPORTER_OTLP_ENDPOINT` et ObjectOS
émettra les traces et les métriques au format OTLP. La forme des spans
correspond au [flux de requête](/docs/architecture#how-a-request-is-served).
