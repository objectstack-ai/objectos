...
| **[Data model](/docs/build/data-model)** | Objects + fields + relationships + state machines | Data Model |
| **[Actions](/docs/build/actions)** | Named operations callable from REST, Console buttons, flows, or AI agents | Actions |
| **[Flows](/docs/build/flows)** | Declarative business logic (autolaunched / scheduled / manual) | Flows |
...
2. **Building a real product on top?** → Read [Packages](/docs/build/packages)
   and [Data Model](/docs/build/data-model) so you understand what the
