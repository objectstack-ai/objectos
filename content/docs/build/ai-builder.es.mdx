...
- [Data Model](/docs/build/data-model) — lo que la IA está generando realmente
- [Actions](/docs/build/actions) — la unidad que la IA expone como herramientas en tiempo de ejecución
