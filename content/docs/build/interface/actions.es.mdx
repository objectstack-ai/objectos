...
No vuelvas a declarar estas — siguen los [indicadores de ciclo de vida y capacidad](/docs/build/data) del objeto.
...
- [Flows](/docs/build/automation/flows) — compón varias acciones en lógica de negocio
