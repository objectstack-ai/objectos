...
Deklarieren Sie diese nicht erneut — sie folgen den [Lebenszyklus- & Capability-Flags](/docs/build/data-model) des Objekts.
...
- [Flows](/docs/build/flows) — mehrere Actions zu Geschäftslogik zusammensetzen
