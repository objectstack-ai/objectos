...
これらは object 上で `enable: { feeds: true, trackHistory: true, … }` を指定することで有効化します。[Data Model](/docs/build/data-model) を参照してください。

## 次に読むべきもの

- [Marketplace](/docs/build/marketplace) — パッケージを他のテナントに配布する
- [Data Model](/docs/build/data-model) — パッケージの中に入るもの
